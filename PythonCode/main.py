...
from serial_connection import setup_serial_connection, create_arduino_thread, read_weight_adjusted_interval, read_heart_rate
...
time_last_update = time.time() # Record the time the game starts

# Setup connection to the Arduino 
